...
public class ProductSearchBox extends Component implements HasComponents {
    ...
    public ProductSearchBox(AbstractSearchDialog dialog) {
        productSearchField = new ComboBox<>();
        sellerSearchField = new ComboBox<>();
        ...
        VerticalLayout  searchPanel = new VerticalLayout(upperSearchPanel, sellerSearchField);
        add(searchPanel);
    }
    ...
    private void initDialog(AbstractSearchDialog dialog) {
        ...
        searchCriteria.put(Seller_.CODE, sellerSearchField.getValue().getCode());
